...
VALUES
('00000000-0000-0000-0000-000000000001', 'PICKUP', 'SCHEDULED', 'CONFIRMED', NULL, NULL, NULL, NULL, NULL, 'John', 'Doe', '123456789', '13:00:00', 15, NULL, now(), now(), 0)
ON CONFLICT (id) DO NOTHING;

-- Order lines for the above order
INSERT INTO order_lines (id, order_id, menu_item_id, quantity, unit_price, menu_item_version)
VALUES
('10000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001', 'pizza', 1, 30.00, 1),
('10000000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000001', 'cake', 1, 15.00, 1)
ON CONFLICT (id) DO NOTHING;

-- Additional sample orders that tests can rely on (if needed)
INSERT INTO orders (id, order_type, delivery_mode, order_status, delivery_street, delivery_house_number, delivery_apartment_number, delivery_city, delivery_postal_code, customer_first_name, customer_last_name, customer_phone_number, scheduled_for, estimated_preparation_minutes, cancellation_reason, placed_at, updated_at, version)
VALUES
('00000000-0000-0000-0000-000000000002', 'DELIVERY', 'SCHEDULED', 'CONFIRMED', 'Main', '1', NULL, 'City', '00-000', 'Jane', 'Doe', '987654321', '13:00:00', 15, NULL, now(), now(), 0)
ON CONFLICT (id) DO NOTHING;

INSERT INTO order_lines (id, order_id, menu_item_id, quantity, unit_price, menu_item_version)
VALUES
('10000000-0000-0000-0000-000000000003', '00000000-0000-0000-0000-000000000002', 'wrap', 1, 18.00, 1)
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO order_lines (id, order_id, menu_item_id, quantity, unit_price, menu_item_version)
VALUES
('10000000-0000-0000-0000-000000000004', '00000000-0000-0000-0000-000000000004', 'burger', 1, 11.00, 1)
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO order_lines (id, order_id, menu_item_id, quantity, unit_price, menu_item_version)
VALUES
('10000000-0000-0000-0000-000000000005', '00000000-0000-0000-0000-000000000005', 'fries', 1, 5.00, 1)
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO order_lines (id, order_id, menu_item_id, quantity, unit_price, menu_item_version)
VALUES
('10000000-0000-0000-0000-000000000006', '00000000-0000-0000-0000-000000000006', 'sandwich', 2, 8.50, 1)
ON CONFLICT (id) DO NOTHING;
